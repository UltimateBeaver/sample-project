#!/usr/bin/env bash
#SBATCH --job-name=Evaluation_Quintuples_Quality
...
#SBATCH --output=logs/quintuples_quality_stdout.log    # Standard output log file
#SBATCH --error=logs/quintuples_quality_stderr.log     # Standard error log file
...
echo "Starting evaluation > Quintuples quality test"
