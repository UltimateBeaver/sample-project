#!/usr/bin/env bash
#SBATCH --job-name=Evaluation_Stability
...
#SBATCH --output=logs/stability_stdout.log    # Standard output log file
#SBATCH --error=logs/stability_stderr.log     # Standard error log file
...
echo "Starting evaluation > Stability test"
